...
df_nodelist = pd.read_excel('./data/chinacoaldb TEST with bins.xlsx', sheet_name='node data')
df_edges = pd.read_excel('./data/chinacoaldb TEST with bins.xlsx', sheet_name='edge data')
