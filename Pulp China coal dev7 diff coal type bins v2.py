...
# Constraint: Mass Balance: nodes cannot supply themselves with coal types they do not have
for item in supplylist:
...
# Flows of each type fo coal over each edge cannot be negative: dealt with in variable defintion
...
# ##### Objective function
# cn_coal_problem += (lpSum([massflowtype[(i,j,ct)]*transportcosts[(i,j)] for (i,j,ct) in flowslist]) + # all transport costs
