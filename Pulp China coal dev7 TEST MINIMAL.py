...
df_nodes = pd.read_excel('./data/chinacoaldb TEST with diff coal types TEST MINIMAL.xlsx', sheet_name='node data')
df_edges = pd.read_excel('./data/chinacoaldb TEST with diff coal types TEST MINIMAL.xlsx', sheet_name='edge data')
df_supply = pd.read_excel('./data/chinacoaldb TEST with diff coal types TEST MINIMAL.xlsx', sheet_name='supply data')
df_coaltypes = pd.read_excel('./data/chinacoaldb TEST with diff coal types TEST MINIMAL.xlsx', sheet_name='coal type data')
...
massflowtot = LpVariable.dicts("flow_total",edgelist,lowBound = 0,upBound=None,cat=LpInteger)
massflowtype = LpVariable.dicts("flow_by_coaltype",flowslist,lowBound = 0,upBound=None,cat=LpInteger)
supplyitembynode = LpVariable.dicts("supply_coaltype_by_node",supplylist,lowBound = 0,upBound=None,cat=LpInteger)
