...
df_edges = df_edges[['orig_city', 'dest_city', 'capacity_plan_Mty']]
df_edges = df_edges[df_edges['capacity_plan_Mty']!=0]
...
df_edges['weight'] = df_edges['capacity_plan_Mty']/100
# Define map/graph
...
plt.savefig('./fig/maprailchinaplanned.png', bbox_inches = 'tight',pad_inches = 0)
plt.savefig('./fig/maprailchinaplanned.pdf',dpi=300, bbox_inches = 'tight',pad_inches = 0)