...
### Save
plt.savefig('./fig/prod plus rail planned.png', bbox_inches = 'tight',pad_inches = 0)
plt.savefig('./fig/prod plus rail planned.pdf',dpi=300, bbox_inches = 'tight',pad_inches = 0)