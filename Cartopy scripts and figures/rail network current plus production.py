...
### Save
plt.savefig('./fig/prod plus rail current.png', bbox_inches = 'tight',pad_inches = 0)
plt.savefig('./fig/prod plus rail current.pdf',dpi=300, bbox_inches = 'tight',pad_inches = 0)